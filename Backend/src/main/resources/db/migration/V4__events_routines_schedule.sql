...
CREATE TABLE schedule_blocks (
    ...
    CONSTRAINT schedule_blocks_task_fk    FOREIGN KEY (task_id) REFERENCES tasks(id) ON DELETE SET NULL,
    CONSTRAINT schedule_blocks_event_fk   FOREIGN KEY (event_id) REFERENCES events(id) ON DELETE SET NULL,

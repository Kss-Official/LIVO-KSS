...
export const OfflineScreen: React.FC<OfflineScreenProps> = ({
  ...
  const handleTryAgain = async () => {
    ...
    try {
      ...
      setIsRetrying(false);
      setConnectionStatus('No internet connection found.');
    }
  };
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <View style={styles.illustrationContainer}>
          <Image
            source={require('../../assets/offline_phone.png')}
        ...
        <View style={styles.textContainer}>
          ...
          <Text style={styles.subtitle}>
            It looks like you're not connected to the internet. Your changes will sync when you're back online.
          </Text>
          {connectionStatus && (
        ...
        {/* 5. "Working Offline" Info Card with chevron */}
        <TouchableOpacity
        ...
        >
          ...
          <View style={styles.infoTextWrapper}>
            ...
            <Text style={styles.infoDescription}>
              You can still view your saved tasks, notes, habits and more. We'll sync everything once you're back online.
            </Text>
          </View>
